...
/* harmony import */ var object_hash__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! object-hash */ "./node_modules/object-hash/dist/object_hash.js");
/* harmony import */ var object_hash__WEBPACK_IMPORTED_MODULE_29___default = /*#__PURE__*/__webpack_require__.n(object_hash__WEBPACK_IMPORTED_MODULE_29__);
...
function identifier(request) {
  return object_hash__WEBPACK_IMPORTED_MODULE_29__({
    url: request.url,
...
function isCached(_x) {
  return _isCached.apply(this, arguments);
}

function _isCached() {
  _isCached = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.t0 = isObjectEmpty;
            _context.next = 3;
...
function cacheResponse(request, response) {
  chrome.storage.local.set(_defineProperty({}, identifier(request), {
...
function getCachedResponse(_x2) {
  return _getCachedResponse.apply(this, arguments);
}

function _getCachedResponse() {
  _getCachedResponse = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(request) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return chrome.storage.local.get([identifier(request)]);
          ...
          case 2:
            ...
            url = params.get('url');
            _context2.next = 8;
            return chrome.storage.local.get([identifier(_objectSpread(_objectSpread({}, request), {}, {
              url: url
            }))]);
          ...
          case 9:
            return _context2.abrupt("return", Object.values(result)[0]);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            _context3.next = 6;
            return chrome["debugger"].attach(debuggee, '1.1');

          case 6:
            console.log('Attached to debugger');
            _context3.next = 9;
            return chrome["debugger"].sendCommand(debuggee, 'Fetch.enable', {
              patterns: [{
...
function _handleResponse() {
  _handleResponse = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(params) {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 3;
            return chrome["debugger"].sendCommand(debuggee, 'Fetch.continueResponse', {
          ...
          case 5:
            _context4.next = 7;
            return isCached(params.request);
          ...
          case 7:
            ...
            _context4.next = 10;
            return getCachedResponse(params.request);

          case 10:
            res = _context4.sent;
            _context4.next = 13;
            return chrome["debugger"].sendCommand(debuggee, 'Fetch.fulfillRequest', _objectSpread({
              requestId: params.requestId
            }, res));
          ...
          case 15:
            _context4.next = 17;
            return chrome["debugger"].sendCommand(debuggee, 'Fetch.getResponseBody', {
              requestId: params.requestId
            });
          ...
          case 17:
            ...
            _context4.next = 21;
            return chrome["debugger"].sendCommand(debuggee, 'Fetch.fulfillRequest', {
              requestId: params.requestId,
...
function _handleRequest() {
  _handleRequest = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(params) {
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            console.log(identifier(params.request));
            _context5.t0 = params.resourceType !== 'XHR';
          ...
          case 6:
            ...
            _context5.next = 9;
            return chrome["debugger"].sendCommand(debuggee, 'Fetch.continueRequest', {
              requestId: params.requestId
            });
          ...
          case 11:
            ...
            return chrome["debugger"].sendCommand(debuggee, 'Fetch.continueRequest', {
              requestId: params.requestId,
              url: "https://example.com/?url=".concat(params.request.url)
            });
